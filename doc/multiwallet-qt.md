...
In order to support loading of multiple wallets in ximblock-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ximblock.cpp.
...
Changes to ximblock.cpp
----------------------
ximblock.cpp is the entry point into ximblock-qt, and as such, will require some minor modifications to provide hooks for
