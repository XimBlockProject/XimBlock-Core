...
This mechanism has been integrated into Bitcore-Node-XIM which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/XIM-Project/insight-api-ximblock#web-socket-api](https://github.com/XIM-Project/insight-api-ximblock#web-socket-api) 
* API: [https://github.com/XIM-Project/insight-api-ximblock#swifttx-transactions](https://github.com/XIM-Project/insight-api-ximblock#swifttx-transactions) 
...
By default, the XIM Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the XIM Core daemon:
