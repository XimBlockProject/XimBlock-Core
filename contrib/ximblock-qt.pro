...
RESOURCES += src/qt/ximblock.qrc src/qt/ximblock_locale.qrc

TRANSLATIONS += src/qt/locale/ximblock_bg.ts \
                src/qt/locale/ximblock_de.ts \
                src/qt/locale/ximblock_en.ts \
                src/qt/locale/ximblock_es.ts \
                src/qt/locale/ximblock_fi.ts \
                src/qt/locale/ximblock_fr.ts \
                src/qt/locale/ximblock_it.ts \
                src/qt/locale/ximblock_ja.ts \
                src/qt/locale/ximblock_pl.ts \
                src/qt/locale/ximblock_pt.ts \
                src/qt/locale/ximblock_ru.ts \
                src/qt/locale/ximblock_sk.ts \
                src/qt/locale/ximblock_sv.ts \
                src/qt/locale/ximblock_vi.ts \
                src/qt/locale/ximblock_zh_CN.ts \
                src/qt/locale/ximblock_zh_TW.ts
