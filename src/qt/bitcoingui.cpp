                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("XIM Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a XIM address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ximblock: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zXIM"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About XIM Core"), this);
    aboutAction->setStatusTip(tr("Show information about XIM Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for XIM"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your XIM addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified XIM addresses"));
    ...
    openAction->setStatusTip(tr("Open a XIM: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the XIM Core help message to get a list with possible XIM command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("XIM Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to XIM network", "", count));
}
...
{
    QString strTitle = tr("XIM Core"); // default title
