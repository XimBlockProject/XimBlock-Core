...
/* XimBlock GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "XIM"
#define QAPP_ORG_DOMAIN "ximblock.org"
#define QAPP_APP_NAME_DEFAULT "XIM-Qt"
#define QAPP_APP_NAME_TESTNET "XIM-Qt-testnet"
