...
/** Utility functions used by the XIM Qt UI.
 */
namespace GUIUtil
{
...
// Render XIM addresses in monospace font
...
// Parse "ximblock:" URI into recipient object, return true on successful parsing
