...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* XIM features */
        {"ximblock", "masternode", &masternode, true, true, false},
        {"ximblock", "listmasternodes", &listmasternodes, true, true, false},
        {"ximblock", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ximblock", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ximblock", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"ximblock", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"ximblock", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"ximblock", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ximblock", "masternodedebug", &masternodedebug, true, true, false},
        {"ximblock", "startmasternode", &startmasternode, true, true, false},
        {"ximblock", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ximblock", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ximblock", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ximblock", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ximblock", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ximblock", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ximblock", "mnbudget", &mnbudget, true, true, false},
        {"ximblock", "preparebudget", &preparebudget, true, true, false},
        {"ximblock", "submitbudget", &submitbudget, true, true, false},
        {"ximblock", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ximblock", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ximblock", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ximblock", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ximblock", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ximblock", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ximblock", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ximblock", "checkbudgets", &checkbudgets, true, true, false},
        {"ximblock", "mnsync", &mnsync, true, true, false},
        {"ximblock", "spork", &spork, true, true, false},
        {"ximblock", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> ximblock-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:42993/\n";
}
