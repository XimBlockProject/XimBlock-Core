...
void FillBlockPayee(CMutableTransaction& txNew, CAmount nFees,
		bool fProofOfStake, bool fZXIMStake) {
	CBlockIndex* pindexPrev = chainActive.Tip();
	if (!pindexPrev)
		return;
	...
	// } else {
	masternodePayments.FillBlockPayee(txNew, nFees, fProofOfStake, fZXIMStake);
	// }
}
...
void CMasternodePayments::FillBlockPayee(CMutableTransaction& txNew,
		int64_t nFees, bool fProofOfStake, bool fZXIMStake) {
	CBlockIndex* pindexPrev = chainActive.Tip();
