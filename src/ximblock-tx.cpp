...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("XimBlock Core ximblock-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ximblock-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ximblock transaction") + "\n" +
                               "  ximblock-tx [options] -create [commands]   " + _("Create hex-encoded ximblock transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ximblock transaction
