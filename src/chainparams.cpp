...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("00000d18651a180f205c45c91893796a083a1b91a3ab95f640b1dfa10577125a"))
    (50, uint256("00000040a345d73ac9b45f81191102a7f2b645e5b467aa140860422caaab92c9"))
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 42992;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // XIM starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // XIM: 1 day
        nTargetSpacing = 1 * 60;  // XIM: 0.5 minute
        nMaturity = 30;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "XIM Genesis Block: 2018/09/05 12:00:00";
        ...
        genesis.nNonce = 32719;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000d18651a180f205c45c91893796a083a1b91a3ab95f640b1dfa10577125a"));
        assert(genesis.hashMerkleRoot == uint256("0x86ba7b317b7cfaef57a5f1ed4c60b43f126d8cfd947af03ca8bd9077e1b65d15"));

        // vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "ximblock.seed.fuzzbawls.pw"));     // Primary DNS Seeder from Fuzzbawls
        // vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "ximblock.seed2.fuzzbawls.pw"));    // Secondary DNS Seeder from Fuzzbawls
        // vSeeds.push_back(CDNSSeedData("coin-server.com", "coin-server.com"));         // Single node address
        // vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddns.net")); // Single node address
        // vSeeds.push_back(CDNSSeedData("178.254.23.111", "178.254.23.111"));           // Single node address

        vSeeds.push_back(CDNSSeedData("ximblock.io", "seed1.ximblock.io"));
        vSeeds.push_back(CDNSSeedData("ximblock.io", "seed2.ximblock.io"));
        vSeeds.push_back(CDNSSeedData("ximblock.io", "seed3.ximblock.io"));
        vSeeds.push_back(CDNSSeedData("ximblock.io", "seed4.ximblock.io"));
        vSeeds.push_back(CDNSSeedData("ximblock.io", "seed5.ximblock.io"));
        vSeeds.push_back(CDNSSeedData("ximblock.io", "seed6.ximblock.io"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // XIM: 1 day
        nTargetSpacing = 1 * 60;  // XIM: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        genesis.nNonce = 1473812;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0xfc02c8d305deaaec9f6e4b6717d3031c4684642a8fde89ce4316257be9984755"));

        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "ximblock-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "ximblock-testnet.seed2.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("s3v3nh4cks.ddns.net", "s3v3nh4cks.ddns.net"));
        vSeeds.push_back(CDNSSeedData("88.198.192.110", "88.198.192.110"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 137); // Testnet ximblock addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet ximblock script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet ximblock BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet ximblock BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet ximblock BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // XIM: 1 day
        nTargetSpacing = 1 * 60;        // XIM: 1 minutes
        ...
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 51476;
        assert(hashGenesisBlock == uint256("0x440c1d0b025a74666826c9b12e4d3da5a4c951e737a5d922674a0e64dcdbce73"));
