Contributing to XIM Core
============================

The XIM Core project operates an open contributor model where anyone is
...
The following applies to code changes to the XIM Core project, and is not to be
confused with overall XIM Network Protocol consensus changes.

Whether a pull request is merged into XIM Core rests with the project merge
...
Patches that change XIM consensus rules are considerably more involved than
...
Where a patch set proposes to change the XIM consensus, it must have been
...
The project leader is the release manager for each XIM Core release.
